	...
	<tr>
		<td align="center" height="100%" valign=middle><br>
			<table width="30%" border="1" cellspacing="0" cellpadding="3" bgcolor="#FFCC66" bordercolor="#FFFFFF" bordercolorlight="#000000">
				<tr>
					<td height=40 align="center" style="font-size: 15px;"><b>회원관리[등록]</b></a>
					</b></td>
				</tr>
			</table><br>
			<form id="user" name="user" method="post" action="/Admin/User">
			<input type="hidden" name="cmd" value="userWritepro">
				...
				<tr>
					<td><table width="100%" border="0" cellpadding="6" cellspacing="1" bgcolor="DDDDDD">
							<tr>
								...
								<td bgcolor="ffffff"><input name="userid" id="userid" type="text" style="width:350; height:18; padding:2; border:1 solid slategray" size="120"></td>
							</tr>
							<tr bgcolor="EcECEC">
							...
							<tr>
								...
								<td bgcolor="ffffff"><input name="passwd" id="passwd" type="password" style="width:150; height:18; padding:2; border:1 solid slategray" size="20"></td>
							</tr>
							<tr bgcolor="EcECEC">
								<td align="center" bgcolor="EcECEC"><strong>전화번호</strong></td>
								<td bgcolor="ffffff"><input name="tel" id="tel" type="text" style="width:350; height:18; padding:2; border:1 solid slategray" size="120"></td>
							</tr>
							<tr>
			...
			<table width="60%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align=center><a href="javascript:user_send()"><b>[등록]</b></a>&nbsp; <a href="javascript:history.back()"><b>[취소]</b></a></td>
				</tr>
			</table>
			</form>
		</td>
