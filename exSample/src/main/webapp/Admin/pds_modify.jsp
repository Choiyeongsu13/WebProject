	...
	<tr>
		<td align="center" height="100%" valign=middle><br>
			<table width="30%" border="1" cellspacing="0" cellpadding="3" bgcolor="#FFCC66" bordercolor="#FFFFFF" bordercolorlight="#000000">
				<tr>
					<td height=40 align="center" style="font-size: 15px;"><b>자료실[수정]</b></a>
					</b></td>
				</tr>
			</table><br>
			<form id="pds" name="pds" method="post" action="/Admin/Pds">
			<input type="hidden" name="cmd" value="pdsModifypro">
				...
				<tr>
					<td><table width="100%" border="0" cellpadding="6" cellspacing="1" bgcolor="DDDDDD">
							...
							<tr>
								...
								<td bgcolor="ffffff"><input name="subject" id="subject" type="text" value="${dto.subject}" style="width:350; height:18; padding:2; border:1 solid slategray" size="120"></td>
							</tr>
							<tr bgcolor="EcECEC">
								<td align="center" bgcolor="EcECEC"><strong>내용</strong></td>
								<td bgcolor="ffffff">
										<textarea name="contents" id="contents" cols="62" rows="10" class="textfield">${dto.contents}</textarea>
								</td>
							</tr>
							<tr>
			...
			<table width="60%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align=center><a href="javascript:pds_send()"><b>[수정]</b></a>&nbsp; <a href="javascript:history.back()"><b>[취소]</b></a></td>
				</tr>
			</table>
			</form>
		</td>
