                  ...
                  <tr>
                    <td><table width="100%" border="0" cellpadding="6" cellspacing="1" bgcolor="DDDDDD">
                      ...
                      <tr>
                        ...
                        <td bgcolor="#FFFFFF"><a href="/Admin/Pds?cmd=pdsView&idx=${dto.idx}" class="unnamed1">${dto.subject}</a></td>
                      ...
                      <tr>
                        <td colspan="10" align="center" bgcolor="#FFFFFF"><table width="610" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width=20% align="right"><a href="/Admin/Pds?cmd=pdsList"><b>[검색]</b>  &nbsp;<a href="/Admin/Pds?cmd=pdsWrite"><b>[글쓰기]</b></a></td>
                            </tr>
                        </table></td>
                      </tr>
                    </table>
