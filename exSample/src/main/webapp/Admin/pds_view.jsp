	...
	<tr>
		<td align="center" height="100%" valign=middle><br>
			<table width="30%" border="1" cellspacing="0" cellpadding="3" bgcolor="#FFCC66" bordercolor="#FFFFFF" bordercolorlight="#000000">
				<tr>
					<td height=40 align="center" style="font-size: 15px;"><b>자료실 내용보기</b></a>
					</b></td>
				</tr>
			</table><br>
			...
			<table width="60%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align=center><a href="/Admin/Pds?cmd=pdsModify&idx=${dto.idx}"><b>[수정]</b></a>&nbsp; <a href="javascript:void(0)" onclick="if(confirm('정말 삭제하시겠습니까?')) location.href='/Admin/Pds?cmd=pdsDeletepro&idx=${dto.idx}'"><b>[삭제]</b></a>&nbsp; <a href="/Admin/Pds?cmd=pdsList"><b>[목록]</b></a></td>
				</tr>
			</table>
		</td>
	</tr>
