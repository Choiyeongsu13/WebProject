	...
	<tr>
		<td align="center" height="100%" valign=middle><br>
			<table width="30%" border="1" cellspacing="0" cellpadding="3" bgcolor="#FFCC66" bordercolor="#FFFFFF" bordercolorlight="#000000">
				<tr>
					<td height=40 align="center" style="font-size: 15px;"><b>자료실[등록]</b></a>
					</b></td>
				</tr>
			</table><br>
			<form id="pds" name="pds" method="post" action="/Admin/Pds">
			<input type="hidden" name="cmd" value="pdsWritepro">
			...
			<table width="60%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align=center><a href="javascript:pds_send()"><b>[등록]</b></a>&nbsp; <a href="javascript:history.back()"><b>[취소]</b></a></td>
				</tr>
			</table>
			</form>
		</td>
