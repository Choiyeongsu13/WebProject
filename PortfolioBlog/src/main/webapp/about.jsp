		...
		<div class="section-main skilltable">
			...
			<div class="skillrow">
				...
				<span class="skillrow-list">
					<span>Java</span><span>JavaScript</span><span>SQL</span><span>HTML / CSS</span>
				</span>
			</div>
			...
			<div class="skillrow">
				...
				<span class="skillrow-list">
					<span>JSP</span><span>Servlet</span><span>JDBC</span>
				</span>
			</div>
			...
			<div class="skillrow">
				...
				<span class="skillrow-list">
					<span>Eclipse</span><span>Git</span><span>Tomcat</span>
				</span>
			</div>
	...
	<div class="section-body">
		...
		<div class="section-main timeline">
			...
			<div class="tl-item">
				...
				<span class="tl-body">
					<span class="tl-date" style="display:block;">[입학연도] &mdash; <fmt:message key="about.now" /></span>
